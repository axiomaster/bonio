...
export async function injectAndSend(options) {
    try {
        let inputPoint = typeof options.inputX === 'number' && typeof options.inputY === 'number'
        ...
        let sendPoint = typeof options.sendX === 'number' && typeof options.sendY === 'number'
