...
static json tools_array() {
  ...
  tools.push_back(json::parse(R"___({"type":"function","function":{"name":"memo.save","description":"Save a structured memo/note. Use when the user asks to remember, save, or note something from the screen or conversation.","parameters":{"type":"object","properties":{"title":{"type":"string","description":"Short title for the memo"},"content":{"type":"string","description":"The content to save"},"source":{"type":"string","description":"Source of the memo (e.g. screen, voice)"},"tags":{"type":"array","items":{"type":"string"}},"sourceApp":{"type":"string"},"pageTitle":{"type":"string"},"pageLink":{"type":"string"},"coverImage":{"type":"string","description":"Optional base64 JPEG thumbnail for the memo"}},"required":["title","content"]}}})___"));
