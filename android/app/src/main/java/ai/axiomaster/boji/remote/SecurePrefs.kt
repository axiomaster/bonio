...
package ai.axiomaster.boji.remote
...
class SecurePrefs(context: Context) {
  companion object {
    val defaultWakeWords: List<String> = listOf("boji", "claude")
    private const val displayNameKey = "node.displayName"
    private const val voiceWakeModeKey = "voiceWake.mode"
    private const val plainPrefsName = "boji.node"
    private const val securePrefsName = "boji.node.secure"
  }
