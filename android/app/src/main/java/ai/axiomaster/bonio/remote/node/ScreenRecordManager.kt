...
import ai.axiomaster.bonio.ScreenCaptureRequester
import ai.axiomaster.bonio.PermissionRequester
...
class ScreenRecordManager(private val context: Context) {
  ...
  suspend fun record(paramsJson: String?): Payload =
    withContext(Dispatchers.Default) {
      ...
      val format = parseJsonString(params, key = "format")
      ...
      val file = File.createTempFile("bonio-screen-", ".mp4")
