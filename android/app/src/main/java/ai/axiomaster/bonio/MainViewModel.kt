...
import ai.axiomaster.bonio.remote.node.CanvasController
import ai.axiomaster.bonio.remote.node.ScreenCaptureManager
import ai.axiomaster.bonio.remote.node.ScreenRecordManager
...
class MainViewModel(app: Application) : AndroidViewModel(app) {
  private val runtime: NodeRuntime = (app as BonioApp).runtime
  ...
  private val _serverConfig = kotlinx.coroutines.flow.MutableStateFlow<ai.axiomaster.bonio.remote.config.ServerConfig?>(null)
  val serverConfig: StateFlow<ai.axiomaster.bonio.remote.config.ServerConfig?> = _serverConfig

  private val ttsManager = ai.axiomaster.bonio.remote.chat.SystemTtsManager(app)
  ...
  fun updateServerConfig(defaultModel: String? = null, models: List<ai.axiomaster.bonio.remote.config.ModelConfig>? = null) {
    viewModelScope.launch {
  ...
  private val _skills = MutableStateFlow<List<ai.axiomaster.bonio.remote.skills.SkillInfo>>(emptyList())
  val skills: StateFlow<List<ai.axiomaster.bonio.remote.skills.SkillInfo>> = _skills
  ...
  private val clawHubClient = ai.axiomaster.bonio.remote.skills.ClawHubClient()

  private val _marketplaceResults = MutableStateFlow<List<ai.axiomaster.bonio.remote.skills.ClawHubSearchResult>>(emptyList())
  val marketplaceResults: StateFlow<List<ai.axiomaster.bonio.remote.skills.ClawHubSearchResult>> = _marketplaceResults
  ...
  private val _selectedMarketSkill = MutableStateFlow<ai.axiomaster.bonio.remote.skills.ClawHubSkillDetail?>(null)
  val selectedMarketSkill: StateFlow<ai.axiomaster.bonio.remote.skills.ClawHubSkillDetail?> = _selectedMarketSkill
  ...
  fun getThemeAssetPath(state: AgentState): String {
    val avatarState = ai.axiomaster.bonio.avatar.AvatarState(activity = state)
