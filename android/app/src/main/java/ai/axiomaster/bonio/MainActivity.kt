...
import ai.axiomaster.bonio.ui.theme.BonioTheme
...
class MainActivity : ComponentActivity() {
    ...
    override fun onResume() {
        super.onResume()
        android.util.Log.d("BonioApp", "MainActivity onResume")
    ...
    private fun startFloatingWindowService() {
        android.util.Log.d("BonioApp", "MainActivity starting FloatingWindowService")
    ...
    private fun requestTelephonyPermissions() {
        ...
        if (needed.isNotEmpty()) {
            Log.i("BonioApp", "Requesting telephony permissions: $needed")
