...
import ai.axiomaster.bonio.remote.protocol.OpenClawCalendarCommand
import ai.axiomaster.bonio.remote.protocol.OpenClawCanvasA2UICommand
import ai.axiomaster.bonio.remote.protocol.OpenClawCanvasCommand
import ai.axiomaster.bonio.remote.protocol.OpenClawCameraCommand
import ai.axiomaster.bonio.remote.protocol.OpenClawContactsCommand
import ai.axiomaster.bonio.remote.protocol.OpenClawDeviceCommand
import ai.axiomaster.bonio.remote.protocol.OpenClawInputCommand
import ai.axiomaster.bonio.remote.protocol.OpenClawLocationCommand
import ai.axiomaster.bonio.remote.protocol.OpenClawMotionCommand
import ai.axiomaster.bonio.remote.protocol.OpenClawNotificationsCommand
import ai.axiomaster.bonio.remote.protocol.OpenClawScreenCommand
import ai.axiomaster.bonio.remote.protocol.OpenClawSmsCommand
import ai.axiomaster.bonio.remote.protocol.OpenClawSystemCommand
import ai.axiomaster.bonio.remote.protocol.OpenClawTelephonyCommand

class InvokeDispatcher(
  private val canvas: CanvasController,
  private val cameraHandler: CameraHandlerImpl,
  private val locationHandler: LocationHandlerImpl,
  private val deviceHandler: DeviceHandlerImpl,
  private val notificationsHandler: NotificationsHandlerImpl,
  ...
  suspend fun handleInvoke(command: String, paramsJson: String?): GatewaySession.InvokeResult {
    ...
    return when (command) {
      ...
      // Photos command
      "photos.latest" -> photosHandler.handlePhotosLatest(paramsJson)
